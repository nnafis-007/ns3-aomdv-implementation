...
\begin{itemize}
    \item For \textbf{wired networks}, the full parameter set was too computationally intensive and unstable for AOMDV. Therefore, reduced parameter values were used.
    \item For \textbf{wireless networks}, PPS values were scaled down due to hardware limitations and simulation runtime constraints.
\end{itemize}
...
\begin{itemize}
    \item Customized traffic generation to control PPS dynamically
    \item Logging mechanisms added for:
        \begin{itemize}
            \item Throughput
            \item Delay
            \item Packet delivery and drop ratios
            \item Energy consumption
        \end{itemize}
    \item Simulation scripts adapted to support iterative parameter sweeps
\end{itemize}
